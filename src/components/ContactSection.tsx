    ...
    <section id="contact" className="py-24 bg-gradient-to-b from-card/30 to-background">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-3xl font-bold mb-4 inline-block border-b-2 border-accent pb-2">Get In Touch</h2>
          ...
          <div className="space-y-8 animate-fade-in" style={{ animationDelay: "200ms" }}>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="mailto:hello@johndoe.dev" className="text-foreground/70 hover:text-accent transition-colors">
                  hello@johndoe.dev
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="tel:+11234567890" className="text-foreground/70 hover:text-accent transition-colors">
                  +1 (123) 456-7890
                </a>
              </div>
            </div>
            ...
            <div className="pt-4">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-card hover:bg-accent/10 p-3 rounded-full transition-colors">
